...
do
  ...
  *)
  ...
  do
    case $data in
    ETTh1)
      thres=0.1; pr=0.02; ema=0.6; lr=1e-4;;
    ETTh2)
      thres=0.01; pr=0.01; ema=0.5; lr=1e-5;;
    ETTm1)
      thres=0.001; pr=0.05; ema=0.9; lr=1e-4;;
    ETTm2)
      thres=0.01; pr=0.10; ema=0.5; lr=1e-5;;
    weather)
      thres=0.001; pr=0.02; ema=0.8; lr=1e-4;;
    esac
